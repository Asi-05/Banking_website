"""Validierung & Sicherheits-Helfer (Utils-Schicht).

Dieses Modul enthält kleine, wiederverwendbare Funktionen für Validierung und
Sicherheitsaufgaben (z. B. Passwort-Hashing, IBAN-Checks, Datumslogik).
Es gehört zur Utils-Schicht und wird vor allem von der Service-Schicht genutzt,
damit die Fachlogik (Services) sauber bleibt und Regeln an einer Stelle stehen.
"""
